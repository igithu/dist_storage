...
#build the storage_client
#must have the bootstrap.sh file or be failed for sure
#must install automake

BUILD_ROOT=$PWD
START_FILE=$BUILD_ROOT/storage_client.sh
CLIENT_PATH=$BUILD_ROOT/dsclient
CLIENT_BIN_PATH=$CLIENT_PATH/bin
CONF_PATH=$BUILD_ROOT/../../conf
CONF_FILE=$CONF_PATH/storage_client.ini 
...
mv storage_client $CLIENT_BIN_PATH && \
...
echo "build the storage_client successfully!!"
